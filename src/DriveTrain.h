...
{
  public:
    DriveTrain(LocationManager &lcmObj, MWodometry &X1, MWodometry &X2, MWodometry &Y1, int ENCATCdiff, int AllocateError, int DecreaseRadius) : LCM(lcmObj), XAxis_1(X1), XAxis_2(X2), YAxis_1(Y1),encoderAttachDiff(ENCATCdiff), allocateError(AllocateError), decreaseRadius(DecreaseRadius){};
